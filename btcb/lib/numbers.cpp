...
thread_local CryptoPP::AutoSeededRandomPool btcb::random_pool;
...
bool btcb::uint256_union::decode_account (std::string const & source_a)
{
	...
	if (!error)
	{
                ...
                auto btcb_prefix (source_a[0] == 'b' && source_a[1] == 't' && source_a[2] == 'b' && source_a[3] == 'c' && (source_a[4] == '_' || source_a[4] == '-'));
...
bool btcb::uint128_union::decode_dec (std::string const & text)
{
