...
btcb::rpc_secure::rpc_secure (boost::asio::io_service & service_a, btcb::node & node_a, btcb::rpc_config const & config_a) :
...
{
	auto connection (std::make_shared<btcb::rpc_connection_secure> (node, *this));
...
btcb::rpc_connection_secure::rpc_connection_secure (btcb::node & node_a, btcb::rpc_secure & rpc_a) :
btcb::rpc_connection (node_a, rpc_a),
...
void btcb::rpc_connection_secure::read ()
{
	auto this_l (std::static_pointer_cast<btcb::rpc_connection_secure> (shared_from_this ()));
