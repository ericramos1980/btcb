...
receive_minimum (btcb::bcb_ratio),
online_weight_minimum (60000 * btcb::Gbcb_ratio),
...
block_processor_batch_max_time (std::chrono::milliseconds (5000))
{
	...
	epoch_block_signer = btcb::genesis_account;
	switch (btcb::btcb_network)
	{
...
//			preconfigured_representatives.push_back (btcb::account ("67556D31DDFC2A440BF6147501449B4CB9572278D034EE686A6BEE29851681DF"));
//			preconfigured_representatives.push_back (btcb::account ("5C2FBB148E006A8E8BA7A75DD86C9FE00C83F5FFDBFD76EAA09531071436B6AF"));
//			preconfigured_representatives.push_back (btcb::account ("AE7AC63990DAAAF2A69BF11C913B928844BF5012355456F2F164166464024B29"));
//			preconfigured_representatives.push_back (btcb::account ("BD6267D6ECD8038327D2BCC0850BDF8F56EC0414912207E81BCF90DFAC8A4AAA"));
//			preconfigured_representatives.push_back (btcb::account ("2399A083C600AA0572F5E36247D978FCFC840405F8D4B6D33161C0066A55F431"));
...
void btcb::node_config::serialize_json (boost::property_tree::ptree & tree_a) const
{
...
bool btcb::node_config::upgrade_json (unsigned version_a, boost::property_tree::ptree & tree_a)
{
	tree_a.put ("version", std::to_string (json_version));
	auto result (false);
	switch (version_a)
	{
		...
		case 2:
		{
			tree_a.put ("inactive_supply", btcb::uint128_union (0).to_string_dec ());
		...
		case 3:
			...
			tree_a.put ("receive_minimum", btcb::bcb_ratio.convert_to<std::string> ());
			result = true;
		case 4:
			tree_a.erase ("receive_minimum");
			tree_a.put ("receive_minimum", btcb::bcb_ratio.convert_to<std::string> ());
		...
		case 8:
			...
			result = true;
		case 9:
			tree_a.put ("state_block_parse_canary", btcb::block_hash (0).to_string ());
			tree_a.put ("state_block_generate_canary", btcb::block_hash (0).to_string ());
			result = true;
		case 10:
			tree_a.put ("online_weight_minimum", online_weight_minimum.to_string_dec ());
...
bool btcb::node_config::deserialize_json (bool & upgraded_a, boost::property_tree::ptree & tree_a)
{
	auto result (false);
	try
	{
...
btcb::account btcb::node_config::random_representative ()
{
	...
	size_t index (btcb::random_pool.GenerateWord32 (0, preconfigured_representatives.size () - 1));
