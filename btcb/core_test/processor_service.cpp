...
TEST (processor_service, bad_send_signature)
{
	...
	btcb::keypair key2;
	btcb::send_block send (info1.head, btcb::test_genesis_key.pub, 50, btcb::test_genesis_key.prv, btcb::test_genesis_key.pub, 0);
...
TEST (processor_service, bad_receive_signature)
{
	...
	btcb::receive_block receive (hash1, hash1, btcb::test_genesis_key.prv, btcb::test_genesis_key.pub, 0);
